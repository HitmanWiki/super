! function() {
    ...
    function e(t, e, n, r) {
        ...
        var i = 3,
            o = function(e) {
                if (0 === i--) return Promise.reject("Hit redirect limit when attempting to fetch " + e + ".");
    ...
    function c(t) {
        var e = JSON.parse(t);
        return e._json = t, e._hash = (new N).hex(t), e
    }
    ...
    function h(t) {
        ...
        return "navigate" !== t.mode.toString() && (e.mode = t.mode), e
    }
    ...
    function f(t) {
        var e = t && t.manifestUrl || "/ngsw-manifest.json",
            ...
            s = new B(I, r),
            a = new D;
        return _.setVerbosity(t.logLevel), t.logHandlers && (_.messages = function(e) {
            return t.logHandlers.forEach(function(t) {
                return t.handle(e)
            })
        }), _.release(), new M(e, n, I, r, i, o, s, a)
    }
    ...
    function v(t) {
        ...
        n && (r = "https://", i = t.substr("https://".length));
        var o = i.indexOf("/");
    ...
    var A, D = function() {
        ...
        E = function() {
            function e(e) {
                var n = this;
                this.install = t, this.activate = t, this.fetch = t, this.message = t, this.push = t, e.addEventListener("install", function(t) {
                    return n.install(t)
        ...
        B = function() {
            ...
            return t.prototype._request = function(t) {
                ...
                var n = this;
                return void 0 === e && (e = !1), e ? this._request(t).then(function(e) {
                    return n._followRedirectIfAny(e, 3, t.url)
                }) : this._request(t)
            }, t.prototype.refresh = function(t) {
                var e;
                return e = "string" == typeof t ? this.adapter.newRequest(this._cacheBust(t)) : this.adapter.newRequest(this._cacheBust(t.url), t), this.request(e, !1)
        ...
        F = function() {
            function t(t, e, n, r, i, o, s, a) {
                this.streamController = t, this.scope = e, this.manifest = n, this.adapter = r, this.cache = i, this.clock = o, this.fetcher = s, this.plugins = a
            }
            return t.prototype.refresh = function(t, e) {
                return void 0 === e && (e = !0), e ? this.fetcher.refresh(t) : this.fetcher.request(t)
                ...
                return this.plugins.reduce(function(t, e) {
                    return e.cleanup && e.cleanup(t), t
                }, [])
    ...
    ! function(t) {
        t[t.DEBUG = 1] = "DEBUG", t[t.TECHNICAL = 2] = "TECHNICAL", t[t.INFO = 3] = "INFO", t[t.STATUS = 4] = "STATUS", t[t.DISABLED = 1e3] = "DISABLED"
    }(A || (A = {}));
    var P, k = function() {
            function t() {
                this.buffer = [], this.verbosity = A.DISABLED, this.messages = function() {
                    return null
                }
            }
            return t.prototype.debug = function(t) {
                ...
                }).join(" ")), t < this.verbosity || (null !== this.buffer ? this.buffer.push({
                    verbosity: t,
                    message: i
                }) : this.messages({
                    verbosity: t,
        ...
        U = u(function(t, e) {
            ! function() {
                function n(t) {
                    ...
                    if (t && t.length)
                        for (r = t.length;
                            (o += 1) < r;) e = t.charCodeAt(o), n = o + 1 < r ? t.charCodeAt(o + 1) : 0, 55296 <= e && e <= 56319 && 56320 <= n && n <= 57343 && (e = 65536 + ((1023 & e) << 10) + (1023 & n), o += 1), e <= 127 ? i += String.fromCharCode(e) : e <= 2047 ? i += String.fromCharCode(192 | e >>> 6 & 31, 128 | 63 & e) : e <= 65535 ? i += String.fromCharCode(224 | e >>> 12 & 15, 128 | e >>> 6 & 63, 128 | 63 & e) : e <= 2097151 && (i += String.fromCharCode(240 | e >>> 18 & 7, 128 | e >>> 12 & 63, 128 | e >>> 6 & 63, 128 | 63 & e));
                    return i
                }

                function r(t) {
                    var e, n, r, i, o, s, a = [];
                    if (e = n = r = i = o = 0, t && t.length)
                        for (s = t.length, t += ""; e < s;) r = t.charCodeAt(e), n += 1, r < 128 ? (a[n] = String.fromCharCode(r), e += 1) : r > 191 && r < 224 ? (i = t.charCodeAt(e + 1), a[n] = String.fromCharCode((31 & r) << 6 | 63 & i), e += 2) : (i = t.charCodeAt(e + 1), o = t.charCodeAt(e + 2), a[n] = String.fromCharCode((15 & r) << 12 | (63 & i) << 6 | 63 & o), e += 3);
                    return a.join("")
                }
                ...
                function s(t, e) {
                    for (var n, r = e ? "0123456789ABCDEF" : "0123456789abcdef", i = "", o = 0, s = t.length; o < s; o += 1) n = t.charCodeAt(o), i += r.charAt(n >>> 4 & 15) + r.charAt(15 & n);
                    return i
                }
                ...
                function f(t, e) {
                    var n, r, i, o, s, a, u, c, h = e.length,
                        f = Array();
                    for (a = Array(Math.ceil(t.length / 2)), o = a.length, n = 0; n < o; n += 1) a[n] = t.charCodeAt(2 * n) << 8 | t.charCodeAt(2 * n + 1);
                    for (; a.length > 0;) {
                        for (s = Array(), i = 0, n = 0; n < a.length; n += 1) i = (i << 16) + a[n], r = Math.floor(i / h), i -= r * h, (s.length > 0 || r > 0) && (s[s.length] = r);
                        f[f.length] = i, a = s
                    }
                    for (u = "", n = f.length - 1; n >= 0; n--) u += e.charAt(f[n]);
                    for (c = Math.ceil(8 * t.length / (Math.log(e.length) / Math.log(2))), n = u.length; n < c; n += 1) u = e[0] + u;
                    return u
                }

                function l(t, e) {
                    var n, r, i, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
                        s = "",
                        a = t.length;
                    for (e = e || "=", n = 0; n < a; n += 3)
                        for (i = t.charCodeAt(n) << 16 | (n + 1 < a ? t.charCodeAt(n + 1) << 8 : 0) | (n + 2 < a ? t.charCodeAt(n + 2) : 0), r = 0; r < 4; r += 1) s += 8 * n + 6 * r > 8 * t.length ? e : o.charAt(i >>> 6 * (3 - r) & 63);
                    return s
                }
                var p;
                p = {
                        ...
                        Base64: function() {
                            ...
                            this.encode = function(r) {
                                var o, s, a, u = "",
                                    c = r.length;
                                for (e = e || "=", r = i ? n(r) : r, o = 0; o < c; o += 3)
                                    for (a = r.charCodeAt(o) << 16 | (o + 1 < c ? r.charCodeAt(o + 1) << 8 : 0) | (o + 2 < c ? r.charCodeAt(o + 2) : 0), s = 0; s < 4; s += 1) u += 8 * o + 6 * s > 8 * c ? e : t.charAt(a >>> 6 * (3 - s) & 63);
                                return u
                            }, this.decode = function(n) {
                                var o, s, a, u, c, h, f, l, p, d, m = "",
                                    y = [];
                                if (!n) return n;
                                o = d = 0, n = n.replace(new RegExp("\\" + e, "gi"), "");
                                do c = t.indexOf(n.charAt(o += 1)), h = t.indexOf(n.charAt(o += 1)), f = t.indexOf(n.charAt(o += 1)), l = t.indexOf(n.charAt(o += 1)), p = c << 18 | h << 12 | f << 6 | l, s = p >> 16 & 255, a = p >> 8 & 255, u = 255 & p, d += 1, 64 === f ? y[d] = String.fromCharCode(s) : 64 === l ? y[d] = String.fromCharCode(s, a) : y[d] = String.fromCharCode(s, a, u); while (o < n.length);
                                return m = y.join(""), m = i ? r(m) : m
                            }, this.setPad = function(t) {
                                return e = t || e, this
                            }, this.setTab = function(e) {
                                return t = e || t, this
                            }, this.setUTF8 = function(t) {
                                return "boolean" == typeof t && (i = t), this
                            }
                        },
                        CRC32: function(t) {
                            var e, r, i, o = 0,
                        ...
                        MD5: function(t) {
                            ...
                            this.hex = function(t) {
                                ...
                                return "boolean" == typeof t && (v = t), this
                            }, this.setPad = function(t) {
                                return g = t || g, this
                            }, this.setUTF8 = function(t) {
                                return "boolean" == typeof t && (w = t), this
                            }
                        },
                        SHA1: function(t) {
                            function e(t) {
                                return t = y ? n(t) : t, a(u(h(t), 8 * t.length))
                            }

                            function r(t, e) {
                                var r, i, o, s, c;
                                for (t = y ? n(t) : t, e = y ? n(e) : e, r = h(t), r.length > 16 && (r = u(r, 8 * t.length)), i = Array(16), o = Array(16), s = 0; s < 16; s += 1) i[s] = 909522486 ^ r[s], o[s] = 1549556828 ^ r[s];
                                return c = u(i.concat(h(e)), 512 + 8 * e.length), a(u(o.concat(c), 672))
                            }

                            function u(t, e) {
                                var n, r, s, a, u, h, f, l, d = Array(80),
                                    m = 1732584193,
                                    y = -271733879,
                                    v = -1732584194,
                                    g = 271733878,
                                    w = -1009589776;
                                for (t[e >> 5] |= 128 << 24 - e % 32, t[(e + 64 >> 9 << 4) + 15] = e, n = 0; n < t.length; n += 16) {
                                    for (a = m, u = y, h = v, f = g, l = w, r = 0; r < 80; r += 1) r < 16 ? d[r] = t[n + r] : d[r] = o(d[r - 3] ^ d[r - 8] ^ d[r - 14] ^ d[r - 16], 1), s = i(i(o(m, 5), c(r, y, v, g)), i(i(w, d[r]), p(r))), w = g, g = v, v = o(y, 30), y = m, m = s;
                                    m = i(m, a), y = i(y, u), v = i(v, h), g = i(g, f), w = i(w, l)
                                }
                            ...
                            this.hex = function(t) {
                                ...
                                return "boolean" == typeof t && (d = t), this
                            }, this.setPad = function(t) {
                                return m = t || m, this
                            }, this.setUTF8 = function(t) {
                                return "boolean" == typeof t && (y = t), this
                            }
                        },
                        SHA256: function(t) {
                            function e(t, e) {
                                return t = e ? n(t) : t, a(g(h(t), 8 * t.length))
                            }
                            ...
                            function r(t, e) {
                                ...
                                var r, i = 0,
                                    ...
                                    s = Array(16),
                                    u = Array(16);
                                for (o.length > 16 && (o = g(o, 8 * t.length)); i < 16; i += 1) s[i] = 909522486 ^ o[i], u[i] = 1549556828 ^ o[i];
                                return r = g(s.concat(h(e)), 512 + 8 * e.length), a(g(u.concat(r), 768))
                            }
                            ...
                            function g(t, e) {
                                var n, r, o, s, a, u, h, f, l, g, A, D, C = [1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225],
                                    E = new Array(64);
                                for (t[e >> 5] |= 128 << 24 - e % 32, t[(e + 64 >> 9 << 4) + 15] = e, l = 0; l < t.length; l += 16) {
                                    for (n = C[0], r = C[1], o = C[2], s = C[3], a = C[4], u = C[5], h = C[6], f = C[7], g = 0; g < 64; g += 1) g < 16 ? E[g] = t[g + l] : E[g] = i(i(i(v(E[g - 2]), E[g - 7]), y(E[g - 15])), E[g - 16]), A = i(i(i(i(f, m(a)), c(a, u, h)), w[g]), E[g]), D = i(d(n), p(n, r, o)), f = h, h = u, u = a, a = i(s, A), s = o, o = r, r = n, n = i(A, D);
                                    C[0] = i(n, C[0]), C[1] = i(r, C[1]), C[2] = i(o, C[2]), C[3] = i(s, C[3]), C[4] = i(a, C[4]), C[5] = i(u, C[5]), C[6] = i(h, C[6]), C[7] = i(f, C[7])
                                }
                                return C
                            }
                            var w, A = !(!t || "boolean" != typeof t.uppercase) && t.uppercase,
                                D = t && "string" == typeof t.pad ? t.pad : "=",
                                C = !t || "boolean" != typeof t.utf8 || t.utf8;
                            this.hex = function(t) {
                                return s(e(t, C))
                            }, this.b64 = function(t) {
                                return l(e(t, C), D)
                                ...
                                return "boolean" == typeof t && (A = t), this
                            }, this.setPad = function(t) {
                                return D = t || D, this
                            }, this.setUTF8 = function(t) {
                                return "boolean" == typeof t && (C = t), this
                        ...
                        SHA512: function(t) {
                            function e(t) {
                                return t = D ? n(t) : t, a(i(h(t), 8 * t.length))
                            }
                            ...
                            function r(t, e) {
                                ...
                                var r, o = 0,
                                    ...
                                    u = Array(32),
                                    c = Array(32);
                                for (s.length > 32 && (s = i(s, 8 * t.length)); o < 32; o += 1) u[o] = 909522486 ^ s[o], c[o] = 1549556828 ^ s[o];
                                return r = i(u.concat(h(e)), 1024 + 8 * e.length), a(i(c.concat(r), 1536))
                            }

                            function i(t, e) {
                                var n, r, i, s = new Array(80),
                                    a = new Array(16),
                                    h = [new o(1779033703, -205731576), new o(-1150833019, -2067093701), new o(1013904242, -23791573), new o(-1521486534, 1595750129), new o(1359893119, -1377402159), new o(-1694144372, 725511199), new o(528734635, -79577749), new o(1541459225, 327033209)],
                                    f = new o(0, 0),
                                    l = new o(0, 0),
                                    w = new o(0, 0),
                                    A = new o(0, 0),
                            ...
                            function c(t, e, n) {
                                t.l = e.l >>> n | e.h << 32 - n, t.h = e.h >>> n | e.l << 32 - n
                            }

                            function p(t, e, n) {
                                t.l = e.h >>> n | e.l << 32 - n, t.h = e.l >>> n | e.h << 32 - n
                            }

                            function d(t, e, n) {
                                t.l = e.l >>> n | e.h << 32 - n, t.h = e.h >>> n
                            }
                            ...
                            function m(t, e, n) {
                                ...
                                t.l = 65535 & r | i << 16, t.h = 65535 & o | s << 16
                            }
                            ...
                            function y(t, e, n, r, i) {
                                ...
                                t.l = 65535 & o | s << 16, t.h = 65535 & a | u << 16
                            }
                            ...
                            function v(t, e, n, r, i, o) {
                                ...
                                t.l = 65535 & s | a << 16, t.h = 65535 & u | c << 16
                            }
                            var g, w = !(!t || "boolean" != typeof t.uppercase) && t.uppercase,
                                A = t && "string" == typeof t.pad ? t.pad : "=",
                                D = !t || "boolean" != typeof t.utf8 || t.utf8;
                            this.hex = function(t) {
                                return s(e(t))
                            }, this.b64 = function(t) {
                                return l(e(t), A)
                        ...
                        RMD160: function(t) {
                            function e(t) {
                                return t = v ? n(t) : t, a(u(c(t), 8 * t.length))
                            }
                            ...
                            function r(t, e) {
                                ...
                                var r, i, o = c(t),
                                    s = Array(16),
                                    h = Array(16);
                                for (o.length > 16 && (o = u(o, 8 * t.length)), r = 0; r < 16; r += 1) s[r] = 909522486 ^ o[r], h[r] = 1549556828 ^ o[r];
                                return i = u(s.concat(c(e)), 512 + 8 * e.length), a(u(h.concat(i), 672))
                            }
                            ...
                            function u(t, e) {
                                var n, r, s, a, u, c, f, l, m, y, v, C, E, B, F = 1732584193,
                                    b = 4023233417,
                                    P = 2562383102,
                                    k = 271733878,
                                    _ = 3285377520;
                                for (t[e >> 5] |= 128 << e % 32, t[(e + 64 >>> 9 << 4) + 14] = e, a = t.length, s = 0; s < a; s += 16) {
                                    for (u = y = F, c = v = b, f = C = P, l = E = k, m = B = _, r = 0; r <= 79; r += 1) n = i(u, h(r, c, f, l)), n = i(n, t[s + g[r]]), n = i(n, p(r)), n = i(o(n, A[r]), m), u = m, m = l, l = o(f, 10), f = c, c = n, n = i(y, h(79 - r, v, C, E)), n = i(n, t[s + w[r]]), n = i(n, d(r)), n = i(o(n, D[r]), B), y = B, B = E, E = o(C, 10), C = v, v = n;
                                    n = i(b, i(f, E)), b = i(P, i(l, B)), P = i(k, i(m, y)), k = i(_, i(u, v)), _ = i(F, i(c, C)), F = n
                                }
                                return [F, b, P, k, _]
                            }
                            ...
                            this.hex = function(t) {
                                ...
                                return "boolean" == typeof t && (m = t), this
                            }, this.setPad = function(t) {
                                return "undefined" != typeof t && (y = t), this
                            }, this.setUTF8 = function(t) {
                                return "boolean" == typeof t && (v = t), this
                            }
                        }
                    ...
                    function(n, r) {
                        var i = !1;
                        "object" == typeof e && (i = e, e && "object" == typeof T && T && T === T.global && (n = T)), "function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() {
                            return p
        ...
        S = 0;
    ! function(t) {
        t[t.STARTUP = 0] = "STARTUP", t[t.READY = 1] = "READY", t[t.UPDATE_PENDING = 2] = "UPDATE_PENDING", t[t.INSTALLING = 3] = "INSTALLING", t[t.LAME = 4] = "LAME"
    }(P || (P = {}));
    var M = function() {
            function t(t, e, n, r, i, o, s, a) {
                var u = this;
                this.manifestUrl = t, this.plugins = e, this.scope = n, this.adapter = r, this.cache = i, this.events = o, this.fetcher = s, this.clock = a, this.state = P.STARTUP, this.pendingUpdateHash = null, this.streamId = 0, this.streams = {}, this.lifecycleLog = [], this.updateListeners = [], this.id = S++, this.ready = new Promise(function(t) {
                    return u.readyResolve = t
                }), this.updatePending = new Promise(function(t) {
                    return u.updatePendingResolve = t
                }), this.scopedCache = new b(this.cache, "ngsw:"), o.install = function(t) {
                    u.lifecycle("install event"), t.waitUntil(Promise.resolve().then(function() {
                        return u.reset()
                    }).then(function() {
                        return u.scope.skipWaiting()
                    }))
                }, o.activate = function(t) {
                    u.lifecycle("activate event"), u.init || u.startup(), t.waitUntil(u.scope.clients.claim())
                }, o.fetch = function(t) {
                    var e = t.request;
                    if (e.url.endsWith("/ngsw.log")) return void t.respondWith(u.status().then(function(t) {
                        return u.adapter.newResponse(JSON.stringify(t, null, 2))
                    }));
                    if (u.state !== P.LAME) {
                        if (u.state !== P.STARTUP || u.init || u.startup(), !u.init) throw new Error("init Promise not present in state " + P[u.state]);
            ...
            return t.prototype.lifecycle = function(t) {
                ...
                var t = this;
                this.init = this.initialize(), this.init.then(function() {
                ...
                return this.fetchManifestFromCache("staged").then(function(n) {
                    return n ? (!t || n._hash === t) && e.openManifest(n).then(function(t) {
                        return e.clearStaged().then(function() {
                            ...
                            if (t) {
                                var r = e.active;
                                e.active = t, e.cleanup(r).then(function() {
                            ...
                            return e.transition(P.READY), !0
                        })
                    }) : (e.transition(P.READY), !1)
                })
                ...
                var t = this;
                return this.state !== P.READY && this.state !== P.UPDATE_PENDING ? (this.lifecycle("skipping update check, in state " + P[this.state]), Promise.resolve(!1)) : this.state === P.UPDATE_PENDING ? Promise.resolve(!0) : Promise.all([this.fetchManifestFromCache("active"), this.fetchManifestFromCache("staged"), this.fetchManifestFromNetwork()]).then(function(e) {
                    var n = e[0],
                        r = e[1],
                        i = e[2];
                    if (!i) return !!r && (t.pendingUpdateHash = r._hash, t.transition(P.UPDATE_PENDING), !0);
                    if (n && n._hash === i._hash) return !1;
                    if (r && r._hash === i._hash) return t.lifecycle("network manifest " + i._hash + " is already staged"), t.pendingUpdateHash = r._hash, t.transition(P.UPDATE_PENDING), !0;
                    var o = Promise.resolve();
                    return r && (t.lifecycle("staged manifest " + r._hash + " is old, removing"), o = t.clearStaged()), o.then(function() {
                        return t.setupManifest(i, t.active)
                    }).then(function() {
                        return t.setManifest(i, "staged")
                    }).then(function() {
                        return t.pendingUpdateHash = i._hash, t.transition(P.UPDATE_PENDING), t.lifecycle("staged update to " + i._hash), !0
                    })
                })
            }, t.prototype.initialize = function() {
                var t = this;
                if (this.init) throw new Error("double initialization!");
                return this.state !== P.STARTUP ? Promise.reject(new Error("driver: initialize() called when not in STARTUP state")) : Promise.all([this.fetchManifestFromCache("active"), this.fetchManifestFromCache("staged")]).then(function(e) {
                    ...
                    return n ? t.openManifest(n).then(function(e) {
                        return e ? (t.lifecycle("manifest " + n._hash + " activated"), t.active = e, r ? r._hash === n._hash ? (t.lifecycle("staged manifest " + r._hash + " is already active, cleaning it up"), t.transition(P.READY), t.clearStaged()) : (t.lifecycle("staged manifest " + r._hash + " present at initialization"), t.pendingUpdateHash = r._hash, t.transition(P.UPDATE_PENDING), null) : void t.transition(P.READY)) : (t.transition(P.LAME), t.clearActive())
                    }) : (t.transition(P.INSTALLING), t.doInstallFromNetwork(), null)
                })
                ...
                return this.fetchManifestFromNetwork().then(function(e) {
                    return e ? t.setupManifest(e, null).then(function(n) {
                        return n ? void t.setManifest(e, "active").then(function() {
                            t.active = n, t.lifecycle("installed version " + e._hash + " from network"), t.transition(P.READY)
                        }) : (t.lifecycle("network manifest setup failed"), t.transition(P.LAME), null)
                    }) : (t.lifecycle("no network manifest found to install from"), t.transition(P.LAME), null)
                })
                ...
                return n.validate().then(function(r) {
                    return r ? n : (e.lifecycle("cached version " + t._hash + " not valid"), e.cleanup(n).then(function() {
                        return null
                    }))
                })
                ...
                var e = this;
                if (this.lifecycle("transition from " + P[this.state] + " to " + P[t]), this.state = t, t === P.READY && null !== this.readyResolve) {
                    var n = this.readyResolve;
                    this.readyResolve = null, n()
                }
                if (t === P.UPDATE_PENDING && null !== this.updatePendingResolve) {
                    ...
                    this.updatePendingResolve = null, n()
                }
                ...
                var n = this;
                if (this.state !== P.READY && this.state !== P.UPDATE_PENDING) return void this.lifecycle("can't handle message in state " + P[this.state]);
                switch (t.cmd) {
                    case "ping":
                        this.lifecycle("responding to ping on " + e), this.closeStream(e);
                        break;
                    case "update":
                        this.updateListeners.push(e), this.state === P.UPDATE_PENDING && null !== this.pendingUpdateHash && this.sendToStream(e, {
                            type: "pending",
                    ...
                    case "checkUpdate":
                        this.checkForUpdate().then(function(t) {
                            n.sendToStream(e, t), n.closeStream(e)
                        });
                        break;
                    case "activateUpdate":
                    ...
                    case "cancel":
                        t.id;
                        if (!this.streams.hasOwnProperty(e)) return;
                        this.active.messageClosed(e), this.maybeRemoveUpdateListener(e), delete this.streams[e];
                        break;
                    case "log":
                ...
                this.streams.hasOwnProperty(t) && (this.streams[t].postMessage(null), delete this.streams[t])
            }, t
        }(),
        R = /^(https?:\/\/[^\/]+)(\/.*)?$/,
        ...
        O = function() {
            ...
            return t.prototype.newRequest = function(t, e) {
                return e && e instanceof Request && (e = h(e)), new Request(t, e)
        ...
        L = function() {
            function t(t, e, n) {
                void 0 === e && (e = {}), this.pattern = t, this.scope = n, this.match = e.match || "exact", "regex" === this.match && (this._regex = new RegExp(t))
            }
            return t.prototype.matches = function(t) {
                switch (t.startsWith(this.scope) && (t = t.substr(this.scope.length)), this.match) {
                    case "exact":
        ...
        j = function() {
            function t(t) {
                this.compare = t, this.head = null, this.tail = null, this.length = 0
            }
            return t.prototype.insert = function(t) {
                if (this.length++, null === this.head) return void(this.head = this.tail = {
                    value: t,
                    next: null,
                    prev: null
                });
                for (var e = this.head; null !== e;) {
                    ...
                    if (n <= 0) return void(null === e.prev ? this.head = this.head.prev = {
                        value: t,
                        next: this.head,
                        prev: null
                    } : e.prev = e.prev.next = {
                ...
                for (var e = this.head; null !== e;) {
                    if (e.value === t) return null !== e.prev ? e.prev.next = e.next : (this.head = e.next, null !== this.head && (this.head.prev = null)), null !== e.next ? e.next.prev = e.prev : (this.tail = e.prev, null !== this.tail && (this.tail.next = null)), void this.length--;
                    e = e.next
                }
                ...
                return this.head === this.tail ? (this.head = null, this.tail = null, t) : (this.head.next.prev = null, this.head = this.head.next, t)
            }, t
        }(),
        q = 100,
        G = function() {
            function t(t, e, n, r, i, o, s) {
                var a = this;
                switch (this.strategy = t, this.config = e, this.adapter = n, this.cache = r, this.matchers = i, this.metadata = o, this.clock = s, e.cache.strategy) {
                    case "fifo":
            ...
            return t.open = function(e, n, r, i, o) {
                ...
                if (!a) throw new Error("No registered optimizeFor handler (" + e.cache.optimizeFor + ") for group " + e.name);
                ...
                return this.config.cache.maxAgeMs && r > this.config.cache.maxAgeMs ? (this.queue.remove(t.url), delete this.metadata[t.url], Promise.all([this.cache.invalidate("cache", t.url), this.cache.invalidate("metadata", t.url)]).then(function() {
                    return {
                        response: null
                    }
                    ...
                    var o = function() {
                        return n.accessCount++, n.accessedTs = e.clock.dateNow(), e.cache.store("metadata", t.url, e.adapter.newResponse(JSON.stringify(n))).then(function() {
                            e.queue.remove(t.url), e.queue.insert(t.url)
                        })
                    };
                    return {
                        response: i,
                ...
                var n = this;
                if (this.metadata[t]) return Promise.reject(new Error("insertIntoCache(" + t + ") but url is already cached"));
                ...
                return Promise.resolve().then(function() {
                    for (var t = Promise.resolve(), e = n.queue.length; e >= (n.config.cache.maxEntries || q);) e--, t = t.then(function() {
                        var t = n.queue.pop();
                        return delete n.metadata[t], Promise.all([n.cache.invalidate("cache", t), n.cache.invalidate("metadata", t)])
                    });
                    return t
                }).then(function() {
                    return Promise.all([n.cache.store("cache", t, e), n.cache.store("metadata", t, n.adapter.newResponse(JSON.stringify(i)))])
                }).then(function() {
                    n.metadata[t] = i, n.queue.insert(t)
                })
            }, t.prototype.updateIntoCache = function(t, e) {
                var n = this,
                    r = this.metadata[t];
                return r ? (r.accessCount++, r.addedTs = r.accessedTs = this.clock.dateNow(), Promise.all([this.cache.store("cache", t, e), this.cache.store("metadata", t, this.adapter.newResponse(JSON.stringify(r)))]).then(function() {
                    n.queue.remove(t), n.queue.insert(t)
        ...
        H = function() {
            function t(t, e) {
                var n = this;
                this.worker = t, this.strategies = {}, this.manifest = t.manifest.dynamic, this.sideEffectQueue = Promise.resolve(), e.forEach(function(t) {
        ...
        W = function() {
            function t(t, e) {
                this.worker = t, this.key = e, this.cacheKey = "external" === e ? e : "external:" + e
            }
        ...
        Y = function() {
            ...
            return Object.defineProperty(t.prototype, "routeManifest", {
                ...
                return e.indexOf(".") !== -1
            }, t.prototype.setup = function(t) {}, t.prototype.fetch = function(t) {
                var e = this,
        ...
        J = function() {
            function t(t, e) {
                this.worker = t, this.key = e, this.cacheKey = "static" === e ? e : "static:" + e
            }
            return Object.defineProperty(t.prototype, "staticManifest", {
                ...
                t.push.apply(t, Object.keys(this.staticManifest.urls).map(function(t) {
                    return function() {
                        return n.worker.cache.load(n.cacheKey, t).then(function(i) {
                            return i ? (x.technical("setup(" + n.cacheKey + ", " + t + "): no need to refresh " + t + " in the cache"), null) : (x.technical("setup(" + n.cacheKey + ", " + t + "): caching from network"), e(n.worker, t, n.cacheKey, r(t))())
                        })
                    }
                }))
                ...
                t.push.apply(t, Object.keys(this.staticManifest.urls).map(function(t) {
                    ...
                    return a === s ? (x.technical("update(" + i.cacheKey + ", " + t + "): no need to refresh " + t + " in the cache"), r(n.worker, i.worker, t, i.cacheKey)) : (x.technical("update(" + i.cacheKey + ", " + t + "): caching from network"), e(i.worker, t, i.cacheKey, o(t)))
                }))
            }, t.prototype.fetch = function(t) {
                return o(this.worker, t, this.cacheKey)
            }, t.prototype.cleanup = function(t) {
        ...
        $ = function() {
            function t(t) {
                this.worker = t, this.streams = [], this.buffer = []
            }
            return Object.defineProperty(t.prototype, "pushManifest", {
                ...
                enumerable: !0,
                configurable: !0
            }), t.prototype.setup = function(t) {}, t.prototype.message = function(t, e) {
                var n = this;
                switch (t.cmd) {
                    case "push":
                        this.streams.push(e), null !== this.buffer && (this.buffer.forEach(function(t) {
                            return n.worker.sendToStream(e, t)
                        }), this.buffer = null)
                }
            }, t.prototype.messageClosed = function(t) {
                var e = this.streams.indexOf(t);
                e !== -1 && (this.streams.splice(e, 1), 0 === this.streams.length && (this.buffer = []))
            }, t.prototype.push = function(t) {
                var e, n = this;
                try {
                    e = JSON.parse(t)
                ...
                this.maybeShowNotification(e), null !== this.buffer ? this.buffer.push(e) : this.streams.forEach(function(t) {
